...
- Run `pnpm prebuild:clean` after changing native-facing values such as `APP_NAME`, `VERSION_CODE`, `VERSION_NAME`, bundle IDs, package IDs, icons, splash assets, or plugin config.
